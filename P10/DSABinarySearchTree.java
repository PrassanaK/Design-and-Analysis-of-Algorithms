...
/////////////////////////////////////////////////////////////////////////////////////
    ...
    public void traverseStart(DSATreeNode<E> root)
    {
    ...
    private Queue<E> inOrder(Queue<E> queue, DSATreeNode<E> currNode)
    {
        //DSAQueueArray<E> queue = new DSAQueueArray<E>();
        if(currNode != null) 
        {
            inOrder(queue, currNode.getLeft());
            queue.add(currNode.getValue());
            inOrder(queue, currNode.getRight());
        }
        return queue;
    }

    private Queue<E> postOrder(Queue<E> queue, DSATreeNode<E> currNode)
    {
        //DSAQueueArray<E> queue = new DSAQueueArray<E>();
        if (currNode != null)
        { 
    ...
    private Queue<E> preOrder(Queue<E> queue, DSATreeNode<E> currNode)
    {
        //DSAQueueArray<E> queue = new DSAQueueArray<E>();
        if(currNode != null)
        {
